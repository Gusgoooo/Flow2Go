...
const ARC_ARROW_SVG =
  '<svg width="53" height="30" viewBox="0 0 53 30" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M35 9.5H30C31.3333 16 37.8 29.2 53 30H0C15.2 29.2 21.6667 16 23 9.5H18L26.5 0L35 9.5Z" fill="url(#paint0_linear_arc)"/><defs><linearGradient id="paint0_linear_arc" x1="26.5" y1="0" x2="26.5" y2="30" gradientUnits="userSpaceOnUse"><stop stop-color="#3A90FF"/><stop offset="1" stop-color="#3EA5FF" stop-opacity="0"/></linearGradient></defs></svg>'
